...
var indexCDN = index.replace('<script data-main="src/main" src="lib/visualizer/components/requirejs/require.js">', '<script data-main="src/mainCDN" src="https://www.lactame.com/visualizer/' + config.visualizer.cdn + '/components/requirejs/require.js">');
